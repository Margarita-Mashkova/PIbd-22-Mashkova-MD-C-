...
namespace MashkovaCar
{
	class Autobus : Car
	{
		...
		public Autobus(int maxSpeed, float weight, Color mainColor, Color dopColor, bool firstVagon, bool secondVagon, bool garmoshka) : base(maxSpeed, weight, mainColor, 190*2+30, 70)
		{
			DopColor = dopColor;
		...
		public override void DrawTransport(Graphics g)
		{
			...
			if (SecondVagon)
			{
				//Корпус2  //Смещаем первый вагон со всеми его элементами по Х на lengthG
